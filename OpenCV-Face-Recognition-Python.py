...
subjects = ["", "Rameshwar", "Elvis Presley"]
...
#load test images
test_img1 = cv2.imread("test-data/test12.jpg")
...
#display both images
cv2.imshow(subjects[1], cv2.resize(predicted_img1, (600, 700)))
cv2.imshow(subjects[2], cv2.resize(predicted_img2, (600, 700)))
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.waitKey(1)
cv2.destroyAllWindows()
